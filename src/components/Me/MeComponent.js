  ...
  return (
    ...
    <div class="max-w-screen-md px-10 py-6 mx-4 mt-20 bg-white rounded-lg shadow md:mx-auto border-1">
      <div class="flex flex-col items-start w-full m-auto sm:flex-row">
        ...
        <div class="flex flex-col pt-4 mx-auto my-auto sm:pt-0 sm:mx-0">
          <div class="flex flex-col mx-auto sm:flex-row sm:mx-0 ">
            <h2 class="flex pr-4 text-xl font-light text-gray-900 sm:text-3xl">AlPeFe</h2>
            <div class="flex">
              <a
                class="flex items-center px-1 text-sm font-medium text-gray-900 bg-transparent border border-gray-600 rounded outline-none sm:ml-2 hover:bg-blue-600 hover:text-white focus:outline-none hover:border-blue-700">Edit
                profile</a>
      ...
      <div class="w-full pt-5">
        <h1 class="text-lg font-semibold text-gray-800 sm:text-xl">Alex Perez</h1>
        <p class="text-sm text-gray-500 md:text-base">.Net Developer</p>
